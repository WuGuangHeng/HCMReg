"""
Inference script for HCMReg on IXI dataset.
Loads pretrained MambaFusev6 weights (dsc0.769).
Usage: python infer_IXI.py
"""
import os
import torch
...
if __name__ == '__main__':
    ...
    config = get_config('IXI')
    config['dataset'] = 'IXI'

    # Load pretrained MambaFusev6 weights
    ckpt_path = get_pretrained_path('IXI')
