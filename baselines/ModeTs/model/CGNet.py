...
class GlobalCorrModule(nn.Module):
    def __init__(self, embed_dim, window_size=[10, 12, 10]):
        super().__init__()
        self.embed_dim = embed_dim
...
class CGNet(nn.Module):
    def __init__(self, channel_num=16):
        ...
        self.conv_5 = DualConvBlock(channel_num * 16 * 2 + 1200, channel_num * 16)
...
if __name__ == '__main__':
    ...
    print('Number of parameters: %.3f M' % (num_trainable_params/1e6))
