...
def main():
    ...
    lr = 0.0001
    model_folder = 'MindBoggle-CGNet_ncc_{}_reg_{}_jac_{}_dice_{}_lr_{}/'.format(
    ...
    # Im2grid
    # model = Im2grid(img_size_s, channels=4)

    # ModeT
    head_dim = 6
    num_heads = [8, 4, 2, 1, 1]
    # model = ModeT(img_size_s, head_dim=head_dim, num_heads=num_heads, scale=1)

    # RDP
    # model = RDP(img_size_s,channels=4)
