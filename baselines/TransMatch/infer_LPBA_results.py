...
from model.TransMatch import TransMatch
import random
...
def main():
    ...
    weights = [1, 4, 0, 0]  # loss weights
    lr = 0.001
    model_folder = '{}-TransMatch_ncc_{}_reg_{}_jac_{}_dice_{}_lr_{}/'.format(dataset,
