"""
Inference script for HCMReg on LPBA40 dataset.
Loads pretrained MambaFusev6 weights (dsc0.732).
Usage: python infer_LPBA.py
"""
import os
import torch
...
if __name__ == '__main__':
    ...
    ckpt_path = get_pretrained_path('LPBA40')
