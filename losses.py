...
class DiceLoss(torch.nn.Module):
    ...
    def dice_val_VOI(self, y_pred, y_true):
        ...
        elif self.dataset == 'SR_Reg' or self.dataset == 'SR-Reg_data':
    ...
    def forward(self, input, target):
        ...
        return torch.as_tensor(- dice)
    
if __name__ == "__main__":
    loss = Grad3d(penalty='l2')
    pred = torch.randn(1, 1, 160, 192, 160)
    true = torch.randn(1, 1, 160, 192, 160)
